...
export const MoneyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1h4a2 2 0 012 2v10a2 2 0 01-2 2H8a2 2 0 01-2-2V7a2 2 0 012-2h4z" />
  </svg>
);
...
export const ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M17.84,7.24a.5.5,0,0,0-.7,0l-1.3,1.3a.5.5,0,0,0,0,.7l.51.51a.5.5,0,0,0,.7,0l1.3-1.3a.5.5,0,0,0,0-.7Z"/>
    <path d="M19.41,8.81,18.9,8.3a.5.5,0,0,0-.7,0l-1.3,1.3a.5.5,0,0,0,0,.7l.51.51a.5.5,0,0,0,.7,0l1.3-1.3a.5.5,0,0,0,0-.7Z"/>
    <path d="M17,12.24v6.26a2,2,0,0,1-2,2H9a2,2,0,0,1-2-2V12.24a8,8,0,0,1-2.62-4.11,1,1,0,0,1,.35-1L6.2,5.21A3.1,3.1,0,0,1,9,4h6a3.1,3.1,0,0,1,2.8,1.21l1.47,1.92a1,1,0,0,1,.35,1A8,8,0,0,1,17,12.24Z"/>
  </svg>
);
...
export const PaperclipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3.375 3.375 0 1118.375 9.09l-9.566 9.566a1.125 1.125 0 01-1.591-1.591L18.375 9.09m-3.75 3.649l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3.375 3.375 0 1118.375 9.09" />
    </svg>
);
