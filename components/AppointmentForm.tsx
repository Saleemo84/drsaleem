...
import { CameraIcon, PhoneIcon, WhatsAppIcon, ShareIcon, PaperclipIcon, TrashIcon } from './icons';
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={appointment ? t('editAppointment') : t('addAppointment')} t={t}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <InputField label={t('chiefComplaint')} name="chiefComplaint" value={formData.chiefComplaint} onChange={handleChange} />
